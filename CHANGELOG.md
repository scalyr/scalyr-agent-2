...
Bug fixes:
* Fix minimum Python version detection in the deb/rpm package post install script and make sure agent packages also support Python >= 3.10. Contributed by Arkadiusz Skalski (@askalski85).
