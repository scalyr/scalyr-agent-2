...
| `syslog_udp_socket_request_queue_size` | Optional (defaults to `100000`). The maximum number of pending connections that can be queued up before the Agent starts rejecting new connections. |
