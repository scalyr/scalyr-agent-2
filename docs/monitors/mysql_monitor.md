...
|||# ``ca_file``          ||| Location of the ca file to use for the SSL connection. Defaults to None, which means \
                              serve certificate verification won't be performed.will not be verified.
