...
class CopyingManagerFacade(StoppableThread, LogWatcher):
    """
    The CopyingManagerFacade is used to hide the complexity of having sharded CopyingManagers.

    It conforms to the same interface as the original CopyingManager, and is responsible for creating
    and managing multiple copying managers and splitting logs between them.
    """
