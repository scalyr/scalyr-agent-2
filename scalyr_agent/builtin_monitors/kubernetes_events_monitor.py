...
class KubernetesEventsMonitor(ScalyrMonitor):
    ...
    def open_metric_log(self):
        ...
        if len(self.__disk_logger.handlers) == 0:
            ...
            try:
                ...
                global_log.error(
                    "Unable to open KubernetesEventsMonitor log file: %s" % six.text_type(e)
                )
    ...
    def _get_current_leader(self, k8s):
        ...
        try:
            ...
            global_log.error(
                "get current leader: %s, %s" % (six.text_type(e), traceback.format_exc())
            )
                        ...
                        try:
                            ...
                            self.__disk_logger.info(
                                ...
                                % (
                                    ...
                                    six.text_type(scalyr_util.json_encode(extra_fields)),
                                )
                            )
