...
class ProcessMonitor(ScalyrMonitor):
    ...
    def _initialize(self):
        ...
        self.__id = self._config.get("id", required_field=True, convert_to=six.text_type)
        ...
        self.__target_pids = self._config.get("pid", default=None, convert_to=six.text_type)
