                                        ...
                                        if pod:
                                            ...
                                            if default_exclude and not exclude:
                                                logger.log(
                                                    ...
                                                    % (short_cid, six.text_type(pod.annotations)),
                                                )
...
class CRIEnumerator(ContainerEnumerator):
    ...
    def _get_containers(
        ...
        try:
            ...
            global_log.error(
                "Error querying containers %s - %s" % (six.text_type(e), traceback.format_exc()),
                limit_once_per_x_secs=300,
    ...
    * path (the path is always fixed for k8s container logs)
    ...
    def gather_sample(self):
        ...
        try:
            ...
            self._logger.exception("Unexpected error logging metrics: %s" % (six.text_type(e)))
