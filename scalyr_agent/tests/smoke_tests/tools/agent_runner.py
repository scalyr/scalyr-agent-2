...
def _get_default_paths():  # type: () -> Dict[six.text_type, Path]
    default_types = PlatformController.new_platform().default_paths
...
class AgentRunner(object):
    ...
    def __init__(self):  # type: () -> None
        ...
        self._pre_start_callbacks = list()  # type: List[Callable]
        self._post_start_callbacks = list()  # type: List[Callable]
