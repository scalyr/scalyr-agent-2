...
class ScalyrAgent(object):
    ...
    def _fail_if_essential_monitors_are_not_running(self):
        ...
        for monitor_status in monitor_manager_status.monitors_status:
            ...
            if stopped_monitor.stop_agent_if_fails:
                raise Exception(
    ...
    def __run(self, controller):
        # TODO: remove that old __run function after the review and rename the '__new_run'
        return self.__new_run(controller)
