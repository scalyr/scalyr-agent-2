...
def get_user_agent(
        agent_version, use_requests=False, fragments=None, sessions_api_keys_tuple=None
    ):
...
def wrap_response_if_necessary(status_message, bytes_sent, response, block_on_response):
