    ...
    def emit_values(self, values, monitor=None):
        ...
        for key in values:
            ...
            if value_type in six.integer_types or value_type is float:
                ...
                string_entries.append("%s=%s" % (key, six.text_type(value).replace('"', '\\"')))
            else:
    ...
    def __init__(
        ...
        if metric_name is not __NOT_GIVEN__ and metric_value is __NOT_GIVEN__:
            ...
            message = (
                ...
                % (six.text_type(type(metric_value)), six.text_type(metric_value), metric_name)
            )
            ...
            message = (
                ...
                "Only int, long, float, and str are supported."
                % (six.text_type(type(field_value)), six.text_type(field_value), field_name)
            )
        else:
            raise Exception(
