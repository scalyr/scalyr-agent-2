from agent_build.docker_image_builders import DOCKER_DEFAULT_BUILDERS, DOCKER_ADDITIONAL_BUILDERS, ALL_DOCKER_IMAGE_BUILDERS

DEFAULT_DOCKER_TEST_PARAMS = []

for builder_cls in DOCKER_DEFAULT_BUILDERS:
    DEFAULT_DOCKER_TEST_PARAMS.append(
        {"image_builder_name": builder_cls.get_name()}
    )
