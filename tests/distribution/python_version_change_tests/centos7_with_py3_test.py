...
from tests.image_builder.distributions.centos7_with_py3 import CentOSBuilder
...
@pytest.mark.usefixtures("agent_environment")
@dockerized_case(CentOSBuilder, __file__)
def test_centos_only_python_mapped_to_python3(request):
...
@pytest.mark.usefixtures("agent_environment")
@dockerized_case(CentOSBuilder, __file__)
def test_centos_switch_default_to_python3(request):
    common_test_switch_default_to_python3(install_rpm, install_next_version_rpm)


@pytest.mark.usefixtures("agent_environment")
@dockerized_case(CentOSBuilder, __file__)
def test_centos_switch_python2_to_python3(request):
