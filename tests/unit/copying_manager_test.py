...
def _create_test_copying_manager(
    ...
    :return:
    """
    manager = TestableShardedCopyingManager(configuration, monitors)
    ...
    if auto_start:
        ...
        manager.run_and_stop_at(TestableShardedCopyingManager.SLEEPING)
...
class CopyingManagerEnd2EndTest(BaseScalyrLogCaptureTestCase):
    ...
    @pytest.mark.parametrize("a,b,expected", [[1,2,3], [1,2,3]], ids=["forward", "backward"])
