...
class TestCRIStreamBuffers(ScalyrTestCase):
    def test_completed_on_empty(self):
        assert None is CRIStreamBuffers(
    ...
    def test_completed(self):
        ...
        assert None is buffers.append_log_line(
        ...
        assert None is buffers.pop_completed(current_time=1)
        ...
        assert None is buffers.pop_completed(current_time=5)

        assert None is buffers.pop_completed(current_time=10)
        assert (
