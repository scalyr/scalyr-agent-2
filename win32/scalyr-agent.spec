...
service_a = Analysis(
    ["source_root\\scalyr_agent\\platform_windows.py"],
    pathex=[
        "source_root\\scalyr_agent\\third_party",
        "source_root\\scalyr_agent\\third_party_python2",
    ],
...
MERGE(
    (main_a, "scalyr-agent-2", "scalyr-agent-2.exe"),
    (config_a, "scalyr-agent-2-config", "scalyr-agent-2-config.exe"),
    (service_a, "ScalyrAgentService", "ScalyrAgentService.exe"),
)
