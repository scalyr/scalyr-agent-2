...
if __name__ == "__main__":
    ...
    other_files_to_exclude = {
        ...
        *glob.glob(
            os.path.join(root, "agent_build/**/*.py"), recursive=True
        ),
        *glob.glob(
            os.path.join(root, "tests/package_tests/**/*.py"), recursive=True
        ),
        *glob.glob(
            os.path.join(root, "scripts/cicd/**/*.py"), recursive=True
        ),
