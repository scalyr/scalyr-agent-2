...
echo "${REQUIREMENTS_COMMON_PLATFORM_DEPENDENT}" >> "${COMMON_REQUIREMENTS_FILE}"
touch "${BINARY_REQUIREMENTS_FILE}"





/usr/lib/scalyr-agent-2/requirements/python3/bin/python3 -m pip wheel \
  --no-index \
